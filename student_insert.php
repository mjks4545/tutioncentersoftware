...
//data updation
$sql = "INSERT INTO `student` (`student_name`, `father_name`, `roll_no`)
VALUES ('$student_name', '$father_name', '$roll_no')";
$stmt= $conn->prepare($sql);
$stmt->execute();
}
?>
    ...
    Dashboard
        ...
        <section class="content">
          ...
          <div class="form-group col-md-12">
                      ...
                      <input type="text" name="roll_no" class="form-control" placeholder="enter your roll no" >
                    </div>
