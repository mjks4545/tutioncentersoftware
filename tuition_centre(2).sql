...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2016 at 06:28 AM
...
--
ALTER TABLE `accounts`
  MODIFY `account_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
--
...
--
ALTER TABLE `student`
  MODIFY `student_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
--
-- AUTO_INCREMENT for table `student_course_join`
--
ALTER TABLE `student_course_join`
  MODIFY `student_course_join_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
